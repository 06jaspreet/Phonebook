...
// program main menu
   ...
   // System.out.println("What entry you like to edit?");
    
    Node entry = findEntry(phoneBook);

    System.out.println("Enter what you want to edit");
    System.out.println("1 = firstName, 2 = lastName, 3 = phone, 4 = address, 5 = city");
   ...
   public static void deleteEntry(LinkedList phoneBook) {
    ...
    if (entry.firstName.equals (phoneBook.head.firstName) && entry.firstName.equals(phoneBook.head.lastName)) {
